...
export enum AnalyticsCourseTypes {
  LEARNING = "learning",
}

export interface AnalyticsCourseInterface extends Document {
  courseID: string;
  status: AnalyticsCourseStatus;
  types: AnalyticsCourseTypes[];
  title: string;
  term: string;
  start: Date;
  end: Date;
