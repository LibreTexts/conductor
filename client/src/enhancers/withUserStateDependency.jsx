 ...
 *
 * @template P
 * @param {React.ComponentType<P>} WrappedComponent - The component to enhance.
 * @returns {React.FC<P>} The passed component with user information loaded, if available.
 */
