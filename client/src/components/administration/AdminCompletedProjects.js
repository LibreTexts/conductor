...
class AdminCompletedProjects extends Component {
    ...
    getCompletedProjects() {
        axios.get('/admin/projects/completed').then((res) => {
            if (!res.data.err) {
            ...
            <Grid className='component-container' divided='vertically'>
                <Grid.Row>
                    <Grid.Column width={16}>
                        <Header className='component-header'>Completed Administration Projects</Header>
                    </Grid.Column>
                </Grid.Row>
                <Grid.Row>
                    <Grid.Column width={16}>
