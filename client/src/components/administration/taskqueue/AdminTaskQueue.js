...
class AdminTaskQueue extends Component {
    ...
    getAllTasks() {
        axios.get('/admin/taskqueue/all').then((res) => {
            if (!res.data.err) {
                                        ...
                                        <Table.Body>
                                            {this.state.sortedTasks.map((item, index) => {
                                                ...
                                                return (
                                                    <Table.Row key={index}>
                                                        <Table.Cell>
                                                            <p><strong><Link to={`/admin/taskqueue/${item.id}`} className='aproject-table-link'>{item.title}</Link></strong></p>
                                                        </Table.Cell>
                                                        <Table.Cell>
                                                            {item.status === '' ?
