          ...
          <Segment raised>
            ...
            <Form.Field required className="mt-2r">
              ...
              <p>
                ...
                have a transparent background. Resolution should be high enough
                to avoid blurring on digital screens.
              </p>
              <input
                type="file"
                accept="image/jpeg,image/png"
            ...
            <Form.Field required className="mt-2r">
              ...
              <p>
                ...
                logo. This is typically a standard, non-extended wordmark. Logo
                should preferably have a transparent background. Resolution
                should be high enough to avoid blurring on digital screens.{" "}
                <em>
            ...
            <Form.Field className="mt-2p mb-2p">
              ...
              <p>
                A <em>download link</em> to the organization's smallest logo.
                This is typically the same style used for favicons or simplified
                communications branding. Logo should preferably have a
                transparent background. Dimensions should be approximately
                800x800.{" "}
                <em>
                ...
                <Popup
                  content={
                    <span>
                      ...
                      Colleges, etc.). This text will be used on all references
                      to Collections on your Campus Commons.
                      <strong>This text is optional.</strong>
                    </span>
                  }
                  trigger={<Icon name="info circle" />}
              ...
              <label htmlFor="campusFooterColor">
                ...
                <Popup
                  content={
                    <span>
                      A custom hex color code string (e.g. #FFF000) that will
                      change the page footer in Commons. This should be a
                      lighter color than your Primary Color.
                      <strong> This is optional.</strong>
                    </span>
                  }
                  trigger={<Icon name="info circle" />}
          ...
          <Segment raised>
            <div>
              ...
              <p className="">
                ...
                have a specific set of organizations they want users to be able
                to select from. If no custom list is set, the default list from
                LibreTexts will be shown.
              </p>
              <Button
          ...
          <Segment raised>
            <div>
              ...
              <p className="mb-2">
                ...
                in the Commons Catalog search interface. If a Catalog module is
