  ...
  const RenderProjectModules = () => {
          ...
          {canViewDetails && !showDiscussion && (
            <Grid.Column>
              <Segment raised clearing>
                ...
                <Button floated="right" onClick={handleChangeDiscussionVis}>
                  Show
                </Button>
              </Segment>
            </Grid.Column>
    ...
    modules.sort((a, b) => {
      ...
      if(moduleSettings && Object.keys(moduleSettings).length > 0) {
        ...
        return (
          moduleSettings[aIndex].order - moduleSettings[bIndex].order
        )
      }
      return 0;
    })
