...
class DevCompletedProjects extends Component {
    ...
    getCompletedProjects() {
        axios.get('/development/projects/completed').then((res) => {
            if (!res.data.err) {
            ...
            <Grid className='component-container' divided='vertically'>
                <Grid.Row>
                    <Grid.Column width={16}>
                        <Header className='component-header'>Completed Development Projects</Header>
                    </Grid.Column>
                </Grid.Row>
                <Grid.Row>
                    <Grid.Column width={16}>
                            ...
                            <Segment basic className='component-innercontainer'>
                                ...
                                {this.state.sortedProjects.length > 0 &&
                                    <Table celled>
                                        <Table.Header>
                                            <Table.Row>
                                                <Table.HeaderCell width={9}><Header sub>Title</Header></Table.HeaderCell>
...
export default DevCompletedProjects;
